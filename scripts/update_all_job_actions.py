...
add_display_slot("warrior-warrior", "inner-beast", "Inner Beast", "Fell Cleave")
add_display_slot("warrior-warrior", "steel-cyclone", "Steel Cyclone", "Decimate")
...
add_display_slot("astrologian-astrologian", "helios", "Helios", "Helios Conjunction")
...
add_display_slot("summoner-summoner", "ruin", "Ruin", "Ruin III")
...
add_display_slot("redmage-redmage", "impact", "Impact", "Grand Impact")
