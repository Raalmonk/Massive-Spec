...
_attach(
    ...
    [
        ...
        _event("tea-j-kick", "J Kick", 226.1, 4, "aoe", action_id=18516, phase_index=1, phase_time=0),
        _event("tea-judgment-nisi", "Judgment Nisi", 241.3, 6, "mech", action_id=18494, phase_index=1, phase_time=15.2),
        _event("tea-limit-cut", "Limit Cut", 313.5, 6, "mech", action_id=18483, phase_index=1, phase_time=87.4),
        _event("tea-temporal-stasis", "Temporal Stasis", 500.0, 6, "mech", action_id=18522, phase_index=2, phase_time=0),
        _event("tea-inception", "Inception Formation", 537.9, 6, "mech", action_id=18543, phase_index=2, phase_time=37.9),
        _event("tea-wormhole", "Wormhole Formation", 629.3, 6, "mech", action_id=18542, phase_index=2, phase_time=129.3),
        _event("tea-j-storm", "J Storm", 705.7, 50, "aoe", action_id=18550, phase_index=2, phase_time=205.7),
        _event("tea-divine-judgment", "Divine Judgment", 787.3, 5, "aoe", action_id=18554, phase_index=2, phase_time=287.3),
        _event("tea-final-word", "The Final Word", 909.1, 6, "mech", action_id=18557, phase_index=3, phase_time=63.7),
        _event("tea-capital-punishment", "Ordained Capital Punishment", 1008.0, 5, "tb", action_id=18578, phase_index=3, phase_time=162.6),
        _event("tea-almighty-judgment", "Almighty Judgment", 1126.2, 8, "aoe", action_id=18574, phase_index=3, phase_time=280.8),
    ],
)
