...
# Burst / Cooldowns
SAMURAI_MAIN.add_spell(spell_id=7499, cooldown=55, name="Meikyo Shisui", icon="Meikyo_Shisui.png", tags=[SpellTag.DAMAGE])
SAMURAI_MAIN.add_spell(spell_id=7489, cooldown=2.5, name="Higanbana", icon="Higanbana.png", tags=[SpellTag.DAMAGE])
...
SAMURAI_MAIN.add_spell(spell_id=34, cooldown=90, name="Bloodbath", icon="Bloodbath.png", tags=[SpellTag.DEFENSIVE])
SAMURAI_MAIN.add_spell(spell_id=36962, cooldown=15, name="Tengentsu", icon="Tengentsu.png", tags=[SpellTag.DEFENSIVE])
SAMURAI_MAIN.add_spell(spell_id=76, cooldown=90, name="Feint", icon="Feint.png", tags=[SpellTag.DEFENSIVE])
