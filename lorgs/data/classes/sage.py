...
# Self Mitigation
SAGE_MAIN.add_spell(spell_id=24303, cooldown=45, name="Taurochole", icon="Taurochole.png", tags=[SpellTag.DEFENSIVE])
SAGE_MAIN.add_spell(spell_id=24305, cooldown=120, name="Haima", icon="Haima.png", tags=[SpellTag.DEFENSIVE])
...
# Party Mitigation
SAGE_MAIN.add_spell(spell_id=24298, cooldown=30, name="Kerachole", icon="Kerachole.png", tags=[SpellTag.RAID_CD])
SAGE_MAIN.add_spell(spell_id=24299, cooldown=30, name="Ixochole", icon="Ixochole.png", tags=[SpellTag.RAID_CD])
SAGE_MAIN.add_spell(spell_id=24310, cooldown=120, name="Holos", icon="Holos.png", tags=[SpellTag.RAID_CD])
SAGE_MAIN.add_spell(spell_id=24302, cooldown=60, name="Physis II", icon="Physis_II.png", tags=[SpellTag.RAID_CD])
SAGE_MAIN.add_spell(spell_id=24311, cooldown=120, name="Panhaima", icon="Panhaima.png", tags=[SpellTag.RAID_CD])
...
SAGE_MAIN.add_spell(spell_id=37034, cooldown=1.5, name="Eukrasian Prognosis II", icon="Eukrasian_Prognosis_II.png", tags=[SpellTag.RAID_CD])
