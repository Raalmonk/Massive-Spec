...
# Burst / Cooldowns
VIPER_MAIN.add_spell(spell_id=34626, cooldown=2.2, name="Reawaken", icon="Reawaken.png", tags=[SpellTag.DAMAGE])
...
VIPER_MAIN.add_spell(spell_id=34, cooldown=90, name="Bloodbath", icon="Bloodbath.png", tags=[SpellTag.DEFENSIVE])
VIPER_MAIN.add_spell(spell_id=76, cooldown=90, name="Feint", icon="Feint.png", tags=[SpellTag.DEFENSIVE])
