...
NINJA_MAIN.add_spell(spell_id=9167, cooldown=90, name="Bunshin", icon="Bunshin.png", tags=[SpellTag.DAMAGE])
...
NINJA_MAIN.add_spell(spell_id=34, cooldown=90, name="Bloodbath", icon="Bloodbath.png", tags=[SpellTag.DEFENSIVE])
NINJA_MAIN.add_spell(spell_id=2241, cooldown=120, name="Shade Shift", icon="Shade_Shift.png", tags=[SpellTag.DEFENSIVE])
NINJA_MAIN.add_spell(spell_id=76, cooldown=90, name="Feint", icon="Feint.png", tags=[SpellTag.DEFENSIVE])
