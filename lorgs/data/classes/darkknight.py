...
# Burst / Cooldowns
DARK_KNIGHT_MAIN.add_spell(spell_id=3637, cooldown=60, name="Delirium", icon="Delirium.png", tags=[SpellTag.DAMAGE])
...
DARK_KNIGHT_MAIN.add_spell(spell_id=10, cooldown=90, name="Rampart", icon="Rampart.png", tags=[SpellTag.DEFENSIVE])
DARK_KNIGHT_MAIN.add_spell(spell_id=7393, cooldown=15, name="The Blackest Night", icon="The_Blackest_Night.png", tags=[SpellTag.DEFENSIVE])
...
DARK_KNIGHT_MAIN.add_spell(spell_id=3626, cooldown=60, name="Reprisal", icon="Reprisal.png", tags=[SpellTag.DEFENSIVE])

# Party Mitigation
DARK_KNIGHT_MAIN.add_spell(spell_id=16471, cooldown=90, name="Dark Missionary", icon="Dark_Missionary.png", tags=[SpellTag.RAID_CD])
