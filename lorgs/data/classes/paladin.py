...
# Burst / Cooldowns
PALADIN_MAIN.add_spell(spell_id=20, cooldown=60, name="Fight or Flight", icon="Fight_or_Flight.png", tags=[SpellTag.DAMAGE])
...
PALADIN_MAIN.add_spell(spell_id=10, cooldown=90, name="Rampart", icon="Rampart.png", tags=[SpellTag.DEFENSIVE])
PALADIN_MAIN.add_spell(spell_id=25746, cooldown=5, name="Holy Sheltron", icon="Holy_Sheltron.png", tags=[SpellTag.DEFENSIVE])
PALADIN_MAIN.add_spell(spell_id=7382, cooldown=10, name="Intervention", icon="Intervention.png", tags=[SpellTag.DEFENSIVE])
PALADIN_MAIN.add_spell(spell_id=27, cooldown=120, name="Cover", icon="Cover.png", tags=[SpellTag.DEFENSIVE])
PALADIN_MAIN.add_spell(spell_id=30, cooldown=420, name="Hallowed Ground", icon="Hallowed_Ground.png", tags=[SpellTag.DEFENSIVE])
PALADIN_MAIN.add_spell(spell_id=3626, cooldown=60, name="Reprisal", icon="Reprisal.png", tags=[SpellTag.DEFENSIVE])
